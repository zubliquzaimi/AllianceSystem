...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Add Progress') }}</div>
                <div class="card-body">
                   <form method="POST" action="{{ route('progress')}}">
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="prog_Details" rows="3" class="form-control @error('prog_Details') is-invalid @enderror" name="prog_Details" value="{{ old('prog_Details') }}" required autocomplete="prog_Details" autofocus>
                                    </textarea>
                                    @error('prog_Details')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="prog_Date" type="date" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control @error('prog_Date') is-invalid @enderror" name="prog_Date" value="{{ old('prog_Date') }}" required autocomplete="prog_Date" autofocus>
                                    @error('prog_Date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
