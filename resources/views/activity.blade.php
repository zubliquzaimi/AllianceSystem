                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('activity')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="act_ActivityName" type="text" class="form-control @error('act_ActivityName') is-invalid @enderror" name="act_ActivityName" value="{{ old('act_ActivityName') }}" required autocomplete="act_ActivityName" autofocus>
